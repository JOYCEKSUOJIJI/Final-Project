...
exports.handler = async (event) => {
    ...
    const oldItem = await dbClient.get({TableName: 'userTable', Key: {"UserId": requestBody.UserId}}).promise();
    ...
    const token = jwt.sign({UserId: requestBody.UserId, IsAdmin: false}, 'JingPersonalProject');
